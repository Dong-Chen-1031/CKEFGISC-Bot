...
```
【迪斯中學】第32次常會通知
敬請全體成員於114年12月14日（日）11:00前，準時進入會議室頻道參加定期會議。
#會議室
─────────────────────────────
🖼 📌 看到訊息請按下方的「已讀」按鈕
   發布者:Ryan Yang | 迪斯中學DisHighSchool
          [ ✅ 已讀 ]
```
...
- 已讀紀錄存在 `data/notifications.json`，機器人重啟後按鈕依然有效
